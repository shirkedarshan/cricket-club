...
<div class="box">
<center><h2>Add Teams</h2></center><hr>

<form action="addteams_action.php" method="POST" enctype="multipart/form-data" >

<center><strong style="font-size:20">Enter Unique Team Name.</strong></center>
<hr><br>
...
<br><br>
		...
		Player 4 &nbsp &nbsp:
	<input type="text" name="player_4" required />
<br><br>

	Player 5 &nbsp &nbsp:
	<input type="text" name="player_5" required />
<br><br>

	Player 6 &nbsp &nbsp:
	<input type="text" name="player_6" required />
<br><br>

	Player 7 &nbsp &nbsp:
	<input type="text" name="player_7" required />
<br><br>

	Player 8 &nbsp &nbsp:
	<input type="text" name="player_8" required />
<br><br>

	Player 9 &nbsp &nbsp:
	<input type="text" name="player_9" required />
<br><br>

	Player 10 &nbsp &nbsp:
	<input type="text" name="player_10" required />
<br><br>

	Player 11 &nbsp &nbsp:
	<input type="text" name="player_11" required />
<br><br>
<br>

<input type="submit" value="Add Team"/><span>&nbsp &nbsp </span>
